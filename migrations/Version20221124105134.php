 ...
 */
final class Version20221124105134 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE recipe (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(50) NOT NULL, time INTEGER DEFAULT NULL, nb_people INTEGER DEFAULT NULL, difficulty INTEGER DEFAULT NULL, description CLOB NOT NULL, price DOUBLE PRECISION DEFAULT NULL, is_favorite BOOLEAN NOT NULL, created_at DATETIME NOT NULL --(DC2Type:datetime_immutable)
